define(function(require,exports,module){
    ...
    dialog.prototype = {
        ...
        alert:function(opts){
            ...
            if(set.focus) this.doms.btnEnter.focus();
		...
		closeBtntoClose:function(opts){
            var ifr = this.doms.contentBox.getElementsByTagName("iframe")[0];
            if(opts.closeCall){
                if(ifr) opts.closeCall(ifr.contentWindow);
                else opts.closeCall();
            }
			this.close();
		}
    ...
    function createElements(opts){
        ...
        var overlayer = createEl('<div id="dialog_overlayer" style="position:absolute;top:0;left:0;width:100%;height:'+h+'px;background:#000;opacity:.5;filter: Alpha(Opacity=50);z-index:9999;"></div>',db),
            ...
            close = createEl('<a href="javascript:void(0);" id="dialog_btn_close" title="关闭">'+ tips.close +'</a>',contentTitle),
            ...
            btnEnter = createEl('<a href="javascript:;" id="dialog_btn_enter" class="btn_enter btn btn_blue">'+ (opts.enter||tips.enter) +'</a>',btnBox),
            btnCancel = createEl('<a href="javascript:;" id="dialog_btn_cancel" class="btn_cancel btn btn_lightgray">'+(opts.cancel|| tips.cancel) +'</a>')

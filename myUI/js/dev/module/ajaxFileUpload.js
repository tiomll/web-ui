define(function(require,exports,module){
	...
	var ajaxFileUpload = function(opts){ return new ajaxFileUpload.prototype.init(opts); };
	...
	ajaxFileUpload.prototype = {
		...
		*/
		createIframe:function(id,url){
			var frameId = 'ajaxFileUploadFrame'+id, iFrame,
				IE = /msie ((\d+\.)+\d+)/i.test(navigator.userAgent) ? (document.documentMode ||  RegExp['\x241']) : false,
		...
		*/
		uploadCallback:function(id,callback){
			var frame = document.getElementById('ajaxFileUploadFrame'+id), form = document.getElementById('ajaxFileUploadForm'+id), data = {}, db = document.body;
			try{
